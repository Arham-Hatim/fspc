<header class="top-header">
    <nav class="navbar navbar-expand gap-3" style="background: #2c54a3;">
        ...
        <div class="top-navbar-right ms-auto">
            <ul class="navbar-nav align-items-center gap-1">
                ...
                <li class="nav-item dropdown dropdown-large">
                    <a class="nav-link menuBtn " href="#" data-bs-toggle="dropdown">
        ...
        <div class="menuBtn">
            <div class="user-setting d-flex align-items-center gap-3" style="background: #2c54a3;">
