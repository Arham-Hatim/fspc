    ...
    <main class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:;">Bulk Categories</a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Add Bulk Categories</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('DataSample', 'categories') }}" type="button" class="btn btn-primary">Sample</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
        ...
        <div class="row">
            <div class="col-xl-12 mx-auto">
                <div class="card">
                    <div class="card-body">
                        <h6 class="mb-0 text-uppercase white">Add Bulk Categories</h6>
                        <hr />
                        <div class="p-4 border rounded">
                            <form class="row g-3 needs-validation" action="{{ route('categoryImport') }}" method="POST"
